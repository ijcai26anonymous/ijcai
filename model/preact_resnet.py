...
__all__ = ['preact_resnet18','preact_resnet34']
...
class OnlineSpikingResNet(nn.Module):
    def __init__(
        ...
        # wrap_model(self, self.nb_steps, self.rate_flag)
...
def preact_resnet18(pretrained=False, progress=True, single_step_neuron: callable = None, **kwargs):
    return _online_spiking_resnet('resnet18', BasicBlock, [2, 2, 2, 2], pretrained, progress, single_step_neuron,
                                  **kwargs)


def preact_resnet34(pretrained=False, progress=True, single_step_neuron: callable = None, **kwargs):
    return _online_spiking_resnet('resnet34', BasicBlock, [3, 4, 6, 3], pretrained, progress,
