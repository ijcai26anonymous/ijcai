...
parser = argparse.ArgumentParser(description='Training SNN on DVS')
parser.add_argument('--seed', default=60, type=int, help='random seed')

# model setting
parser.add_argument('--stu_arch', default="resnet19", type=str,
...
parser.add_argument('--dataset', default="CIFAR10_DVS", type=str, help="CIFAR10_DVS")
parser.add_argument('--data_path', default="../../dataset/tetdvsc10", type=str)
